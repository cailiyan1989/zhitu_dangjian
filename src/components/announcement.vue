  ...
  methods: {
    ...
    onInfinite(done) {
      if (this.$route.query.status == "policy") {
        ...
        this.$store
          .dispatch("getPolicyNewsList", {
            page: this.newsPolicyCounter,
            type: 2,
            cate: 13
          })
          .then(() => {
        ...
        this.$store
          .dispatch("getDeedsNewsList", {
            page: this.newsDeedsCounter,
            type: 2,
            cate: 14
          })
          .then(() => {
        ...
        this.$store
          .dispatch("getGuideNewsList", {
            page: this.newsGuideCounter,
            type: 2,
            cate: 15
          })
          .then(() => {
